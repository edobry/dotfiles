...
function macosSetup() {
    ...
    local chitinTempDir="/tmp/chitin-install"

    # log "install temporary jq"
    # local jqVersion="1.6"
    # local jqTempPath="$chitinTempDir/jq"
    # curl -sL https://github.com/stedolan/jq/releases/download/jq-$jqVersion/jq-osx-amd64 -o "$jqTempPath"
    # chmod +x "$jqTempPath"
